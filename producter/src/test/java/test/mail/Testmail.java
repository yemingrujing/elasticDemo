...
public class Testmail {
    ...
    // 发送邮件的账号
    public static String ownEmailAccount = "nanmu@taomz.com";
    // 发送邮件的密码------》授权码
    public static String ownEmailPassword = "************";
    // 发送邮件的smtp 服务器 地址
    ...
    public static Message createSimpleMail(Session session) {
        try {
            ...
            message.setFrom(new InternetAddress("nanmu@taomz.com", "张三", "utf-8"));
            // 代表收件人
            ...
            // 设置邮件内容
            message.setContent("<h1>邮件内容</h1>周末，你有空出去玩吗？", "text/html;charset=utf-8");
            // 设置发送时间
