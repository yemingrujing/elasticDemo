import com.test.elasticsearch.EsProducterAppApplication;
...
@SpringBootTest(classes = EsProducterAppApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
